    ...
    <footer className="w-full bg-black/90 text-white/70 mt-16">
      <div className="flex flex-col min-h-[60vh] px-24 max-lg:px-8 py-4">
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="poppins-regular  text-8xl sm:text-8xl md:text-9xl lg:text-[16rem] text-white tracking-tight leading-none">
            PAVE
          </div>
        </div>
          ...
          <div className="flex flex-col gap-4 pb-4">
            ...
            <div className="flex items-center gap-6">
              <a
                ...
                className="poppins-light max-sm:text-base text-xl flex items-center gap-2 hover:text-white transition-colors"
              >
                Twitter
              ...
              <a
                ...
                className="poppins-light max-sm:text-base text-xl hover:text-white transition-colors"
              >
                Email
              </a>
            </div>
